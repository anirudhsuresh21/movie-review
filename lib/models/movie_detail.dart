...
class MovieDetailModel {
  ...
  @override
  String toString() {
    return 'MovieDetailModel{title: $title, overview: ${overview.substring(0, overview.length > 50 ? 50 : overview.length)}..., genres: ${genres.map((g) => g.name).toList()}, runtime: $runtime min, rating: $voteAverage}';
  }
}
